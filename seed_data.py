...
STUDENTS = [
    ...
    ('CS001','Ayesha Siddiqui',     'Computer Science',       'parent.ayesha@gmail.com',   0.92),
    ('CS002','Bilal Ahmed',         'Computer Science',       'bilal.dad@gmail.com',        0.85),
    ('CS003','Fatima Zahra',        'Computer Science',       'fzahra.parent@hotmail.com',  0.78),
    ('CS004','Hassan Raza',         'Computer Science',       'raza.family@gmail.com',      0.55),
    ('CS005','Imran Khan',          'Computer Science',       'imran.guardian@gmail.com',   0.60),
    ('CS006','Javeria Malik',       'Computer Science',       'javeria.mom@gmail.com',      0.95),
    ('CS007','Kamran Sheikh',       'Computer Science',       None,                         0.88),
    ('CS008','Layla Noor',          'Computer Science',       'layla.parent@yahoo.com',     0.72),
    ('EE001','Muhammad Ali',        'Electrical Engineering', 'maliparent@gmail.com',       0.90),
    ('EE002','Nadia Hussain',       'Electrical Engineering', 'nadia.guardian@gmail.com',   0.82),
    ('EE003','Omar Farooq',         'Electrical Engineering', 'farooq.family@gmail.com',    0.50),
    ('EE004','Parveen Akhtar',      'Electrical Engineering', 'pakhtar.mom@gmail.com',      0.88),
    ('EE005','Qasim Butt',          'Electrical Engineering', None,                         0.65),
    ('EE006','Rabia Tariq',         'Electrical Engineering', 'rabia.parent@hotmail.com',   0.93),
    ('EE007','Saad Ullah',          'Electrical Engineering', 'saad.dad@gmail.com',         0.79),
    ('EE008','Tahira Bibi',         'Electrical Engineering', 'tahira.guardian@gmail.com',  0.86),
    ('BA001','Usman Ghani',         'Business Administration','usman.parent@gmail.com',     0.91),
    ('BA002','Vaneeza Ahmed',       'Business Administration','vaneeza.mom@gmail.com',      0.84),
    ('BA003','Waqar Zaman',         'Business Administration','waqar.family@gmail.com',     0.68),
    ('BA004','Xara Niazi',          'Business Administration','xara.parent@yahoo.com',      0.97),
    ('BA005','Yasir Nawaz',         'Business Administration',None,                         0.45),
    ('BA006','Zara Saleem',         'Business Administration','zara.guardian@gmail.com',    0.88),
    ('BA007','Ahsan Iqbal',         'Business Administration','ahsan.dad@gmail.com',        0.76),
    ('BA008','Bushra Hameed',       'Business Administration','bushra.mom@gmail.com',       0.94),
    ('ME001','Daniyar Shah',        'Mechanical Engineering', 'daniyar.parent@gmail.com',   0.87),
    ('ME002','Eman Riaz',           'Mechanical Engineering', 'eman.guardian@gmail.com',    0.80),
    ('ME003','Fahad Mehmood',       'Mechanical Engineering', 'fahad.dad@gmail.com',        0.73),
    ('ME004','Ghazala Pasha',       'Mechanical Engineering', 'ghazala.mom@gmail.com',      0.92),
    ('ME005','Hamza Shahid',        'Mechanical Engineering', None,                         0.58),
    ('ME006','Iqra Javed',          'Mechanical Engineering', 'iqra.parent@hotmail.com',    0.89),
    ('ME007','Junaid Alam',         'Mechanical Engineering', 'junaid.family@gmail.com',    0.95),
    ('ME008','Kiran Bashir',        'Mechanical Engineering', 'kiran.guardian@gmail.com',   0.77),
    ('DS001','Lubna Arshad',        'Data Science',           'lubna.mom@gmail.com',        0.96),
    ('DS002','Mohsin Rauf',         'Data Science',           'mohsin.parent@gmail.com',    0.83),
    ('DS003','Noman Chaudhry',      'Data Science',           None,                         0.61),
    ('DS004','Omaima Yousaf',       'Data Science',           'omaima.dad@gmail.com',       0.90),
    ('DS005','Pervez Musharraf Jr', 'Data Science',           'pervez.guardian@gmail.com',  0.70),
    ('DS006','Quratulain Hyder',    'Data Science',           'quratulain.mom@gmail.com',   0.88),
    ('DS007','Rameez Raja',         'Data Science',           'rameez.parent@gmail.com',    0.52),
    ('DS008','Saima Waheed',        'Data Science',           'saima.guardian@gmail.com',   0.93),
]
